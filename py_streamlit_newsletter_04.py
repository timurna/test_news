...
if not st.session_state.authenticated:
    ...
    if data is None:
        ...
        st.image('logo.png', use_column_width=False, width=800)  # Replace 'logo.png' with your actual logo path
                    ...
                    with st.expander(title, expanded=False):
                        for metric in metrics_list:
                            ...
                            if metric == 'PSV-99':
                                ...
                                # Remove players with NaN in 'Max PSV-99'
                                    ...
                                    for header, tooltip in tooltip_headers.items():
                                        if tooltip:
                                            top10_html = top10_html.replace(
                                                f'>{header}<',
                                                f'><span class="tooltip">{header}<span class="tooltiptext">{tooltip}</span></span><'
                                            )
